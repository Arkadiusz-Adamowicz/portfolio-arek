    ...
    <section className='w-full py-20'>
      ...
      <div className='my-20 flex flex-col lg:flex-row items-center justify-center gap-4'>
        ...
        <Card
          ...
          description="This is where the magic happpens! Based on the approved design, I'll translate everything into functional code, building your website from the ground up"
        >
          <CanvasRevealEffect
            animationSpeed={3}
  ...
  return (
    <div>
      <button className='relative inline-flex h-12 overflow-hidden rounded-full p-[1px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50'>
        ...
        <span className='inline-flex h-full w-full cursor-pointer items-center justify-center rounded-full bg-slate-950 px-5 py-5 text-2xl  text-white font-bold backdrop-blur-3xl'>
          {order}
        </span>
      </button>
    </div>
